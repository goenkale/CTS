...
Enable the Token Simulation and start a new token with a slow speed. Try to follow this scenario 1 switching the gateways in real time using this button image:icons/switchGateway.png[]
...
image::icons/ticketing-scenario1.gif[title="Ticketing BPMN diagram - Token Simulation: Scenario 1 finished"]
